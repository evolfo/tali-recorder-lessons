    ...
    return (
      <div id="about-wrapper">
        <Grid centered id="about">
          <GridColumn stretched="true" tablet={12} computer={7} className="about-text">
            ...
            <p>To learn more about Tali, visit <a href="https://www.talirubinstein.com">www.talirubinstein.com</a>.</p>
          </GridColumn>
          <GridColumn stretched="true" className="about-img" tablet={16} computer={6}>
            <div id="about-card">
              <Image alt="Tali with private recorder student" src={aboutImg2} />
              <Image alt="Tali teaching recorder to a group of kids" src={aboutImg} />
            </div>
          </GridColumn>
        </Grid>
